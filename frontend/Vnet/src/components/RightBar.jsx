export default function RightBar({ activePost }) {
  ...
  const commentsCount =
    activePost.commentsCount || activePost.stats?.comments || 0;
  const views = activePost.viewsCount || activePost.stats?.views || 0;
  ...
  return (
    <div className="h-full px-6 pb-6 overflow-y-auto [&::-webkit-scrollbar]:hidden pt-4">
      ...
      <div className="mb-8 absolute right-12 bottom-0">
        <h2 className="font-bold text-gray-400 mb-4 uppercase tracking-wider flex justify-center text-xs">
          Analytics
        </h2>
